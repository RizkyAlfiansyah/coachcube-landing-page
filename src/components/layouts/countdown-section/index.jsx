...
const CountDown = () => {
    ...
    return (
        <>
            <div className="w-full lg:h-screen h-full bg-countdown bg-cover bg-no-repeat bg-center flex flex-col justify-center items-center gap-8 lg:px-64 px-6 md:px-44">
                <p className="font-bold lg:text-48 text-24 lg:leading-61 leading-31 text-white text-center">
                    A HOME FOR HIGH ACHIVERS
                </p>
                <div className="w-full flex flex-col justify-center items-center lg:gap-9 gap-4 py-3 px-4 lg:py-45 lg:px-86 lg:rounded-4xl rounded-xl bg-primary-650 bg-opacity-10">
