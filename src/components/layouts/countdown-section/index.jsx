    ...
    return (
        <>
            <div className="w-full flex flex-col justify-center items-center gap-8 px-6">
                ...
                <div className="xl:w-10/12 lg:w-[98%] flex flex-col justify-center items-center lg:gap-9 gap-4 p-3 lg:py-45 lg:px-20 lg:pr-12 md:px-11 md:py-6 lg:rounded-4xl rounded-xl bg-primary-860 bg-opacity-[0.35]">
                    ...
                    <div className='w-full flex justify-center items-center lg:gap-2 gap-0'>
                        {
                            Array(4).fill(0).map((_, index) => (
                                <div className={`flex ${index !== 3 ? "items-center justify-center" : "items-center justify-around"} lg:gap-4 md:gap-3 gap-2`} key={index}>
